    ...
    for _e in _all_lines:
        ...
        for _k, _v in _dict.items():
            ...
            if _tns_id > 0:
                ...
                # create record
                _tns = TnsRecord(tns_id=_tns_id, tns_name=_tns_name, tns_link=_tns_link, ra=_ra, dec=_dec,
                                 redshift=_tns_redshift, discovery_date=_tns_discoverydate,
                                 discovery_mag=_tns_discoverymag, discovery_instrument=_tns_discovering_instrument_name,
